...
# console.redhat.com/floorist-operator-bundle:$VERSION and console.redhat.com/floorist-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= quay.io/redhat-services-prod/insights-management-tenant/insights-floorist/floorist-operator
